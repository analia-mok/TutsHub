...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2018 at 04:54 PM
...
(64, 7, 'meta_title', 'text', 'Meta Title', 0, 0, 1, 1, 1, 1, NULL, 7),
(65, 7, 'meta_description', 'text_area', 'Meta Description', 0, 0, 1, 1, 1, 1, NULL, 8),
(66, 7, 'header_background_color', 'color', 'Header Background Color', 0, 0, 1, 1, 1, 1, NULL, 9),
(68, 7, 'created_at', 'timestamp', 'Created At', 0, 1, 1, 1, 0, 1, NULL, 13),
(69, 7, 'updated_at', 'timestamp', 'Updated At', 0, 0, 0, 0, 0, 0, NULL, 12),
(70, 7, 'status', 'select_dropdown', 'Status', 0, 1, 1, 1, 1, 1, '{\"default\":\"DRAFT\",\"options\":{\"PUBLISHED\":\"published\",\"DRAFT\":\"draft\",\"PENDING\":\"pending\"}}', 11),
...
(96, 9, 'guide_id', 'text', 'Guide Id', 0, 0, 1, 1, 0, 0, NULL, 13),
...
(101, 10, 'created_at', 'timestamp', 'Created At', 0, 1, 1, 1, 0, 1, NULL, 13),
(102, 10, 'updated_at', 'timestamp', 'Updated At', 0, 0, 0, 0, 0, 0, NULL, 14),
(103, 10, 'status', 'select_dropdown', 'Status', 0, 1, 1, 1, 1, 1, '{\"default\":\"DRAFT\",\"options\":{\"PUBLISHED\":\"published\",\"DRAFT\":\"draft\",\"PENDING\":\"pending\"}}', 7),
(104, 10, 'guide_belongstomany_category_relationship', 'relationship', 'Categories', 0, 1, 1, 1, 1, 1, '{\"model\":\"App\\\\Category\",\"table\":\"categories\",\"type\":\"belongsToMany\",\"column\":\"id\",\"key\":\"id\",\"label\":\"name\",\"pivot_table\":\"guide_category\",\"pivot\":\"1\",\"taggable\":\"0\"}', 8),
...
(106, 9, 'tutorial_belongsto_guide_relationship', 'relationship', 'Guide', 0, 1, 1, 1, 1, 1, '{\"model\":\"App\\\\Guide\",\"table\":\"guides\",\"type\":\"belongsTo\",\"column\":\"guide_id\",\"key\":\"id\",\"label\":\"name\",\"pivot_table\":\"categories\",\"pivot\":\"0\",\"taggable\":\"0\"}', 15),
(107, 10, 'meta_title', 'text', 'Meta Title', 0, 0, 1, 1, 1, 1, NULL, 10),
(108, 10, 'meta_description', 'rich_text_box', 'Meta Description', 0, 0, 1, 1, 1, 1, NULL, 11),
(109, 10, 'image', 'image', 'Image', 0, 0, 1, 1, 1, 1, '{\"resize\":{\"width\":\"1000\",\"height\":\"null\"},\"quality\":\"70%\",\"upsize\":true,\"thumbnails\":[{\"name\":\"medium\",\"scale\":\"50%\"},{\"name\":\"small\",\"scale\":\"25%\"},{\"name\":\"cropped\",\"crop\":{\"width\":\"300\",\"height\":\"250\"}}]}', 9),
(110, 8, 'image', 'image', 'Image', 0, 0, 1, 1, 1, 1, '{\"resize\":{\"width\":\"1000\",\"height\":\"null\"},\"quality\":\"70%\",\"upsize\":true,\"thumbnails\":[{\"name\":\"medium\",\"scale\":\"50%\"},{\"name\":\"small\",\"scale\":\"25%\"},{\"name\":\"cropped\",\"crop\":{\"width\":\"300\",\"height\":\"250\"}}]}', 11),
(111, 9, 'image', 'image', 'Image', 0, 0, 1, 1, 1, 1, '{\"resize\":{\"width\":\"1000\",\"height\":\"null\"},\"quality\":\"70%\",\"upsize\":true,\"thumbnails\":[{\"name\":\"medium\",\"scale\":\"50%\"},{\"name\":\"small\",\"scale\":\"25%\"},{\"name\":\"cropped\",\"crop\":{\"width\":\"300\",\"height\":\"250\"}}]}', 14),
...
(113, 10, 'author_id', 'text', 'Author Id', 0, 1, 1, 1, 1, 1, NULL, 12);
...
INSERT INTO `pages` (`id`, `title`, `slug`, `header_title`, `header_content`, `meta_title`, `meta_description`, `header_background_color`, `created_at`, `updated_at`, `status`) VALUES
(1, 'Home', 'home', 'This is a Header', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', NULL, NULL, '#000000', '2018-06-07 04:04:00', '2018-06-07 05:36:19', 'PUBLISHED'),
(2, 'Tutorials', 'tutorials', 'Our Tutorials', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', 'Tutorials', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis.', '#7c5dac', '2018-06-07 05:35:39', '2018-06-07 05:35:39', 'PUBLISHED'),
(3, 'Guides', 'guides', 'Our Guides', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', 'Our Guides | TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', '#15bfb1', '2018-06-08 05:46:01', '2018-06-08 05:46:01', 'PUBLISHED'),
(4, 'News', 'news', 'News', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', 'News | TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', '#0086bb', '2018-06-08 05:47:00', '2018-06-08 05:47:36', 'PUBLISHED'),
(5, 'About', 'about', 'About TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', 'About | TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus eu neque congue mollis. Nam dapibus massa non vestibulum venenatis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam sit amet.', '#ffa17a', '2018-06-08 05:48:45', '2018-06-08 05:48:45', 'PUBLISHED'),
(6, 'Terms Of Use', 'terms-of-use', 'Terms of Use', NULL, 'Terms of Use | TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet consectetur quam, non ornare orci. Praesent convallis augue fermentum, sagittis dui a, ultricies urna. Cras nulla purus, lacinia eget dapibus id, condimentum et mi. Nullam sed.', '#15bfb1', '2018-06-10 18:22:00', '2018-06-10 18:24:47', 'PUBLISHED'),
(7, 'Privacy Policy', 'privacy-policy', 'Privacy Policy', NULL, 'Privacy Policy | TutsHub', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet consectetur quam, non ornare orci. Praesent convallis augue fermentum, sagittis dui a, ultricies urna. Cras nulla purus, lacinia eget dapibus id, condimentum et mi. Nullam sed.', '#15bfb1', '2018-06-10 18:25:36', '2018-06-10 18:25:36', 'PUBLISHED');
