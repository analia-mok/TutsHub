                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            <br>
                            <div class="form-group">
                                <input type="checkbox" id="is_employee" name="is_employee"@if(isset($dataTypeContent->is_employee) && $dataTypeContent->is_employee) checked="checked"@endif>
                                <label for="is_employee">Is this user an employee of TutsHub?</label>
                            </div>
                            <div class="form-group">
                                <label for="title">Job Title</label>
                                <input type="text" class="form-control" name="title" id="title" @if(isset($dataTypeContent->title))value="{{ $dataTypeContent->title }}"@endif>
                            </div>
                            <div class="form-group">
                                @php
                                    $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
